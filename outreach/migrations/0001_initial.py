        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "buyable",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="purchases", to="outreach.buyable"
                    ),
                ),
                (
                    "order",
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
                        related_name="buyable_purchases",
                        to="billing.order",
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "lead",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="tours", to="outreach.lead"
                    ),
                ),
            ],
            options={
