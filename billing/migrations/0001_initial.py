    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('distributed_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='distributed_payouts', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'verbose_name': 'Payout',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amount', models.IntegerField(help_text='Amount in cents')),
                ('status', models.CharField(choices=[('on_tab', 'On Tab'), ('billed', 'Billed'), ('paid', 'Paid'), ('failed', 'Failed')], default='on_tab', max_length=20)),
                ...
                ('revenue_split', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='orders', to='billing.revenuesplit')),
            ],
            options={
                'verbose_name': 'Order',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='member_subscriptions', to=settings.AUTH_USER_MODEL)),
