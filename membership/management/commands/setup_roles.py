...
ROLE_PERMISSIONS: dict[str, list[str]] = {
    ...
    "class-manager": [
        ...
        "add_classimage",
        "delete_classimage",
        "view_classdiscountcode",
        "change_classdiscountcode",
        "add_classdiscountcode",
        "delete_classdiscountcode",
        "view_student",
        "change_student",
        "add_student",
        "delete_student",
    ...
    "orientation-manager": [
        ...
        "add_orientation",
        "delete_orientation",
        "view_scheduledorientation",
        "change_scheduledorientation",
        "add_scheduledorientation",
        "delete_scheduledorientation",
    ],
    "accountant": [
        "view_order",
        "change_order",
